...
* **Working example to build a loadable with RetinaNet-ResNet-34 models:**
  ...
  5) Run the sample<pre><code>./cuDLALayerwiseStatsStandalone model_loadable.bin 1152 1 standalone1</pre></code> Layerwise statistics profiling data will be populated in the file with name *standalone11.csv*
